    ...
    <div class="container">
      <div class="flex justify-between items-center">
        ...
        <nav class="flex items-center gap-6">
          ...
          <NuxtLink v-if="!isAuthenticated" to="/login" class="text-base bg-blue-600 px-6 py-2 text-white
            rounded-lg hover:bg-blue-600/80">Login</NuxtLink>
          <NuxtLink v-if="!isAuthenticated" to="/Register" class="text-base bg-orange-500 px-6 py-2 text-white
            rounded-lg hover:bg-orange-600/80">Register</NuxtLink>
